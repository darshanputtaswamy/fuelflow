...
#TODO: get rid of id from url instead use jwt token
@unload_router.get("/resend-verification/{id}")
...
@unload_router.post("/users/login")
async def user_login(credentials: UserCredentials):
    # User login logic here
    return {"access_token": "jwt_token"}


@unload_router.post("/refresh", response_model=Token)
...
@unload_router.post("/users/logout")
